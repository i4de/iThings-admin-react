      ...
      {title && (
        <CollapseItem name="标题" extraNode={() => genExtra(title.show)}>
          <SettingItemBox name="标题">
            <div slot="default">
              <SettingItem name="颜色">
                <div className="color-pick radius set-input-width">
                  <Popover
                    content={
          ...
          <SettingItemBox name="分割线">
            ...
            <SettingItem name="粗细">
              <InputNumber
                ...
                min={-90}
                max={90}
                onChange={(value) => handleInputChange(value, 'xAxis.splitLine.lineStyle', 'width')}
                size="small"
                className="radius set-input-width"
              />
            </SettingItem>
          ...
          <SettingItemBox name="分割线">
            ...
            <SettingItem name="粗细">
              <InputNumber
                ...
                min={-90}
                max={90}
                onChange={(value) => handleInputChange(value, 'yAxis.splitLine.lineStyle', 'width')}
                size="small"
                className="radius set-input-width"
              />
            </SettingItem>
