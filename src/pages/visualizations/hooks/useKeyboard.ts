...
import { setKeyboardDressShow } from '@/utils/utils';
    ...
    switch (e) {
      ...
      case keyboardValue.up:
        keymaster(
          ...
          throttle(() => {
            setDispatch({
              type: 'chartEditStore/setMove',
              payload: {
                keyboardValue: MenuEnum.ARROW_UP,
              },
            });
            return false;
          }, throttleTime),
        ...
        keymaster(
          ...
          throttle(() => {
            setDispatch({
              type: 'chartEditStore/setMove',
              payload: {
                keyboardValue: MenuEnum.ARROW_RIGHT,
              },
            });
            return false;
          }, throttleTime),
        ...
        keymaster(
          ...
          throttle(() => {
            setDispatch({
              type: 'chartEditStore/setMove',
              payload: {
                keyboardValue: MenuEnum.ARROW_DOWN,
              },
            });
            return false;
          }, throttleTime),
        ...
        keymaster(
          ...
          throttle(() => {
            setDispatch({
              type: 'chartEditStore/setMove',
              payload: {
                keyboardValue: MenuEnum.ARROW_LEFT,
              },
            });
            return false;
          }, throttleTime),
